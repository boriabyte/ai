    ...
    for filename in os.listdir(video_folder):
        ...
        while cap.isOpened():
            ...
            if features is not None:
                ...
                finger_logic_features = round_features(finger_logic_features, decimals=4)
                main_frames.append(features)
                logic_frames.append(finger_logic_features)
        ...
        for start in range(0, len(main_frames) - sequence_length + 1, stride):
            ...
            if len(main_clip) == sequence_length and len(logic_clip) == sequence_length:
                X_dataset.append((main_clip, logic_clip))
